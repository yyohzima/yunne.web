...
export function useGetBookIdsQuery(
  options?: Omit<Urql.UseQueryArgs<GetBookIdsQueryVariables>, 'query'>,
) {
  return Urql.useQuery<GetBookIdsQuery, GetBookIdsQueryVariables>({
    query: GetBookIdsDocument,
    ...options,
  })
}
...
export function useGetBooksQuery(
  ...
  return Urql.useQuery<GetBooksQuery, GetBooksQueryVariables>({
